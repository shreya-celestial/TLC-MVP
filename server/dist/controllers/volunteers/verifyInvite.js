...
const verifyInvite = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (token && token !== 'null' && token !== 'NULL') {
        ...
        if (data === null || data === void 0 ? void 0 : data.errors) {
            return res.status(404).send(((_a = data === null || data === void 0 ? void 0 : data.errors[0]) === null || _a === void 0 ? void 0 : _a.message) + ' <a href="https://tlc-mvp-app.vercel.app">Go to safety!</a>');
        }
        ...
        return res.redirect(303, `https://tlc-mvp-app.vercel.app/signup?ticket=${token}&for=${(_g = (_f = data === null || data === void 0 ? void 0 : data.data) === null || _f === void 0 ? void 0 : _f.Invitations[0]) === null || _g === void 0 ? void 0 : _g.email}`);
    }
