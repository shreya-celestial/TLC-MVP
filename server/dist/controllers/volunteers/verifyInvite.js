...
const verifyInvite = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (token && token !== 'null' && token !== 'NULL') {
        ...
        if (data === null || data === void 0 ? void 0 : data.errors) {
            return res.status(404).send(((_a = data === null || data === void 0 ? void 0 : data.errors[0]) === null || _a === void 0 ? void 0 : _a.message) + ' <a href="https://tlc-mvp-app-amber.vercel.app">Go to safety!</a>');
        }
