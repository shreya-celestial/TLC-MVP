...
const verifyLink = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (ticketData) {
            ...
            const data = yield (0, getData_1.default)(queries_1.verifyRequestedLink, ticketData);
            if (data === null || data === void 0 ? void 0 : data.errors) {
                throw new Error((_a = data === null || data === void 0 ? void 0 : data.errors[0]) === null || _a === void 0 ? void 0 : _a.message);
            }
            if (!((_c = (_b = data === null || data === void 0 ? void 0 : data.data) === null || _b === void 0 ? void 0 : _b.link_tickets) === null || _c === void 0 ? void 0 : _c.length)) {
            ...
            const created = new Date((_e = (_d = data === null || data === void 0 ? void 0 : data.data) === null || _d === void 0 ? void 0 : _d.link_tickets[0]) === null || _e === void 0 ? void 0 : _e.created_at);
            const now = new Date();
