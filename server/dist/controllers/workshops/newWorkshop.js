...
const newWorkshop = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const variables = Object.assign(Object.assign({}, req.body), { concluding_date: (0, global_1.formatDate)(req.body.concluding_date), end_date: (0, global_1.formatDate)(req.body.end_date), start_date: (0, global_1.formatDate)(req.body.start_date), vols,
        leads });
