...
const newMeeting = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const data = yield (0, getData_1.default)(mutations_1.addMeeting, variables);
    ...
    if ((_m = (_l = data === null || data === void 0 ? void 0 : data.data) === null || _l === void 0 ? void 0 : _l.insert_meetings) === null || _m === void 0 ? void 0 : _m.affected_rows) {
