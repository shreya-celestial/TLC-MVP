...
const deleteEnrollments = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b, _c, _d, _e;
    ...
    const data = yield (0, getData_1.default)(mutations_1.deleteEnrollmentsById, { ids });
    ...
    if (!((_e = (_d = data === null || data === void 0 ? void 0 : data.data) === null || _d === void 0 ? void 0 : _d.delete_enrollments) === null || _e === void 0 ? void 0 : _e.affected_rows)) {
        return res.status(400).json({
            status: 'error',
...
exports.default = deleteEnrollments;
