...
const newVolunteerEnrollment = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const data = yield (0, getData_1.default)(mutations_1.addVolunteerEnrollment, variables);
...
exports.default = newVolunteerEnrollment;
