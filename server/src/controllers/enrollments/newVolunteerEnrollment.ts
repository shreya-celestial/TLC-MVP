...
const newVolunteerEnrollment = async (req: Request, res: Response) => {
  ...
  const data = await getData(addVolunteerEnrollment, variables)
  if(data?.errors)
  {
...
export default newVolunteerEnrollment